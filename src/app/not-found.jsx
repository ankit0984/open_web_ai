...
/* ─────────────────────────────────────────────
   Star field
   FIX: Math.random() moved into useEffect
...
export default function NotFoundPage() {
  ...
  // FIX: usePathname() instead of window.location.pathname
  ...
  return (
    ...
    >
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 z-[1] h-[520px] w-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full"
        style={{
          background:
      ...
      <main className="relative z-10 flex h-full flex-col items-center justify-between px-6 py-5">
        {/* TOP — badge */}
        <motion.div
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex w-full max-w-lg flex-col items-center gap-3.5 text-center"
        >
          {/* Icon + orbit rings */}
          <motion.div
            variants={fadeUp}
          ...
          >
            <OrbitRing
              radius={52}
              duration={7}
              dotColor="oklch(0.6 0.18 260)"
            />
            <OrbitRing
              radius={38}
              duration={4.5}
              reverse
              dotColor="oklch(0.65 0.14 180)"
            />
            <motion.div
              ...
              className="relative z-10 flex h-16 w-16 items-center justify-center rounded-2xl border border-primary/20 bg-primary/10 shadow-[0_0_36px_oklch(0.55_0.18_260/0.2)]"
            >
              <Telescope className="size-8 text-primary" strokeWidth={1.5} />
            </motion.div>
          </motion.div>
          ...
          >
            <GlitchText className="text-[clamp(4rem,13vw,7rem)] font-black tracking-tighter text-foreground/90">
              404
            </GlitchText>
          </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            custom={0.22}
            className="w-full rounded-lg border border-border/60 bg-muted/40 px-4 py-2.5 text-left backdrop-blur-sm"
          >
            ...
            <div className="mt-1 mb-0.5 space-y-0.5 font-mono text-[11px]">
              <div>
                <span className="text-muted-foreground/50">
                  PATH&nbsp;&nbsp;&nbsp;{" "}
                </span>
                {/* FIX: usePathname() — no SSR mismatch */}
          ...
          <motion.div
            variants={fadeUp}
            custom={0.26}
            className="flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center"
          >
        ...
        <motion.p
          ...
          className="font-mono text-[10px] tracking-widest text-muted-foreground/25 uppercase"
        >
